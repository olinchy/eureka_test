...
public class ProductRepositoryIntegrationTest extends AbstractIntegrationTest {
    ...
    public void findProductsInCustomerOrders() {
        ...
        @SuppressWarnings("unchecked") final List<Product> result = repository.query(
                query, map("email", dave.getEmailAddress())).as(List.class);
    ...
    public void lookupProductsByDescription() {
        ...
        Page<Product> page = repository.findByDescriptionLike(
                "Apple", pageable); // TODO JIRA findByDescriptionContaining
