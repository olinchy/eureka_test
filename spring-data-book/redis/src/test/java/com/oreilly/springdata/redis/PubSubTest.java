...
public class PubSubTest {
    ...
    @Test
    public void testPubSubWithoutConversion() {
    ...
    private class BeanMessageSerializer implements RedisSerializer<BeanMessage> {
        @Override
        public byte[] serialize(BeanMessage beanMessage) throws SerializationException {
            return (null != beanMessage.message ? beanMessage.message.getBytes() : new byte[0]);
        }

        @Override
        public BeanMessage deserialize(byte[] bytes) throws SerializationException {
