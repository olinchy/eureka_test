...
privileged aspect AddressController_Roo_Controller {
    ...
    public String AddressController.create(
            @Valid Address address, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String AddressController.list(
        ...
        if (page != null || size != null) {
            ...
            uiModel.addAttribute(
                    "maxPages", (int) ((nrOfPages > (int) nrOfPages || nrOfPages == 0.0) ? nrOfPages + 1 : nrOfPages));
        } else {
    ...
    public String AddressController.update(
            @Valid Address address, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, address);
    ...
    public String AddressController.delete(
            @PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page,
            @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
