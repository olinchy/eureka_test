...
privileged aspect CustomerController_Roo_Controller {
    ...
    public String CustomerController.create(
            @Valid Customer customer, BindingResult bindingResult, Model uiModel,
    ...
    public String CustomerController.list(
    ...
    public String CustomerController.update(
            @Valid Customer customer, BindingResult bindingResult, Model uiModel,
            HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, customer);
    ...
    public String CustomerController.delete(
